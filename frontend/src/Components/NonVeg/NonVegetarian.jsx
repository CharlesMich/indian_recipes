...
export const NonVegetarian = (ingtype) => {
  ...
  return (
   ...
   <div  className="max-container flex justify-center flex-wrap gap-9 my-10">{ingredients.map((item, idx)=> (
     <Link to={`/dishbynonveg/${idx}`} state={{myMeal: "notexisting", myState: "notexisting", myIngredient: item.name}} key={idx}>
     ...
     <div className="flex flex-row items-center gap-3">
       ...
       <h4 className="font-palanquin text-xl  font-semibold">{item.name}</h4>
